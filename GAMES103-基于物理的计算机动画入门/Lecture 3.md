...
![Rigid_Body_Simulation.png](GAMES103-基于物理的计算机动画入门/images/Rigid_Body_Simulation.png)
...
四元数 $q = (w, x, y, z)$ 与旋转矩阵的转换：![四元数与旋转矩阵的转换.png](GAMES103-基于物理的计算机动画入门/images/四元数与旋转矩阵的转换.png)
